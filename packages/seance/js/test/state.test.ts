import { LiveEventStream } from "../src/events.js";
import {
  LiveState,
  LiveStateChange,
  LiveStateData,
...
describe("LiveState", () => {
  ...
  it("should change state when receiving change event", () => {
